...
for frame in range(frames2):
    drawBot.newPage(7200, 3600)
    drawBot.frameDuration(duration)

    drawBot.image(pattern, (0,0))
    
 #   drawBot.image(pattern1, (1800,1800))
 #   drawBot.image(pattern1, (2400,2400))
 #   drawBot.image(pattern1, (3000,3000))
 #   drawBot.image(pattern1, (2400,1800))
 #   drawBot.image(pattern1, (3000,1800))
    #drawBot.image(pattern1, (1800,2400))
    #first
    drawBot.image(pattern1, (1800,3000))
    #drawBot.image(pattern1, (3000,2400))
   # drawBot.image(pattern1, (2400,3000))
 ...
 #   drawBot.image(pattern2, (3000,600))
   # drawBot.image(pattern2, (3000,1200))
    ...
    #drawBot.image(pattern3, (0,1800))
 #   drawBot.image(pattern3, (0,2400))
 #   drawBot.image(pattern3, (0,3000))
                            #first
    drawBot.image(pattern3, (600,1800))
    #drawBot.image(pattern3, (600,2400))
    #drawBot.image(pattern3, (600,3000))
 #   drawBot.image(pattern3, (1200,1800))
 #   drawBot.image(pattern3, (1200,2400))
  #  drawBot.image(pattern3, (1200,3000))
    

    
 #   drawBot.image(pattern4, (3600,1800))
 #   drawBot.image(pattern4, (3600,2400))
    #drawBot.image(pattern4, (3600,3000))
   # drawBot.image(pattern4, (4200,1800))
    #drawBot.image(pattern4, (4200,2400))
 #   drawBot.image(pattern4, (4200,3000))
    #first
    drawBot.image(pattern4, (4800,1800))
 #   drawBot.image(pattern4, (4800,2400))
 #   drawBot.image(pattern4, (4800,3000))
 ...
 #   drawBot.image(pattern7, (5400,2400))
    #first
    drawBot.image(pattern7, (5400,3000))
 #   drawBot.image(pattern7, (6000,1800))
 #   drawBot.image(pattern7, (6000,2400))
 #   drawBot.image(pattern7, (6000,3000))
 #   drawBot.image(pattern7, (6600,1800))
 #   drawBot.image(pattern7, (6600,2400))
 #   drawBot.image(pattern7, (6600,3000))
...
''''
    ...
    drawBot.image(pattern, (3000,1800))
    drawBot.image(pattern, (3600,1800))
    ...
    drawBot.image(pattern, (7200,3600))
    ...
    drawBot.image(pattern, (7800,1800))
...
cloudinary.utils.cloudinary_url("pattern-neue", version="12345678", secure=True, format="gif")

cloudinary.uploader.upload("/Users/vasilij/Desktop/pattern-new.gif",                           
  public_id = "pattern-neue",
  overwrite = 'true', 
